      ...
      this.userManagementService
        ...
        .then(res => {
          this.alertService.showInfo(
            this.t$(res.headers['x-sevenroomstoreviewproapplicationapp-alert'].toString(), {
              param: decodeURIComponent(res.headers['x-sevenroomstoreviewproapplicationapp-params'].replace(/\+/g, ' ')),
            }),
            { variant: 'danger' },
          );
          this.removeId = null;
